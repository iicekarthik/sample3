  ...
  return (
    <section id="about" className="max-w-6xl mx-auto py-12 px-6">
      ...
      <p className="text-lg text-gray-700 leading-relaxed mb-4">
        Established by the Ritnand Balved Education Foundation, <a href="https://vidyarishi.com/all-courses" target="_blank" rel="noopener noreferrer">Amity</a> empowers
      ...
      <p className="text-lg text-gray-700 leading-relaxed">
        ...
        personalized support services. <a href="https://vidyarishi.com/" target="_blank" rel="noopener noreferrer">Amity</a>’s mission is to provide education
